    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          %> 
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="../../../../../../../Desktop/BlockCahin_Contract-master/BlockCahin_Contract-master/BBSTEST/WebContent/validation.jsp">검증하기</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="btn  btn btn-sm" href="../../../../../../../Desktop/BlockCahin_Contract-master/BlockCahin_Contract-master/BBSTEST/WebContent/login.jsp" >로그인</a>
            </li>
            <li class="nav-item">
              <a class="btn  btn btn-sm" href="../../../../../../../Desktop/BlockCahin_Contract-master/BlockCahin_Contract-master/BBSTEST/WebContent/join.jsp" role="button">회원가입</a>
            </li>
          </ul>
          ...
          %>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="../../../../../../../Desktop/BlockCahin_Contract-master/BlockCahin_Contract-master/BBSTEST/WebContent/board.jsp">계약서 작성</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="../../../../../../../Desktop/BlockCahin_Contract-master/BlockCahin_Contract-master/BBSTEST/WebContent/validation.jsp">검증</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container my-auto">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            ...
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="../../../../../../../Desktop/BlockCahin_Contract-master/BlockCahin_Contract-master/BBSTEST/WebContent/validation.jsp">검증하러 가기</a>
          </div>
        </div>
      </div>
    </header>
