...
import com.boot.contract.util.FileHashExtracter;
...
public class ContractGeneratorTest {
    ...
    public void test1() throws Exception {
        ...
        String value = FileHashExtracter.extractFileHashSHA256(filePath);

        log.info("validate={}","026f4333cf27ca1fbbfab35f4ca1ce8282bbc9d41e08126641f75bddcb07ab28".equals(value));
    }
