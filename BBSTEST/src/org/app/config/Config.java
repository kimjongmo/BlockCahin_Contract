...
public class Config {
	...
	public static final String CA_ORG1_URL = "http://210.123.254.152:7054";
	
	public static final String CA_ORG2_URL = "http://210.123.254.152:8054";
	
	public static final String ORDERER_URL = "grpc://210.123.254.152:7050";
	...
	public static final String ORG1_PEER_0_URL = "grpc://210.123.254.152:7051";
	
	public static final String ORG1_PEER_1 = "peer1.org1.example.com";
	
	public static final String ORG1_PEER_1_URL = "grpc://210.123.254.152:7056";
	
    public static final String ORG2_PEER_0 = "peer0.org2.example.com";
	
	public static final String ORG2_PEER_0_URL = "grpc://210.123.254.152:8051";
	
	public static final String ORG2_PEER_1 = "peer1.org2.example.com";
	
	public static final String ORG2_PEER_1_URL = "grpc://210.123.254.152:8056";
